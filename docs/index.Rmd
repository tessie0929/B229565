...
GPlist_2024 <- read_csv(here("data","practice_contactdetails_oct2024-open-data.csv"))
gp_info <- GPlist_2024 %>% 
...
simd_pc <- read_csv(here("data", "SIMD+2020v2+-+postcode+lookup+-+updated+2025.csv"))
